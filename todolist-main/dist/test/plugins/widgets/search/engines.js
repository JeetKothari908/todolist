...
exports.engines = [
    {
        ...
        suggest_url: "https://www.google.com/complete/search?client=chrome&q={searchTerms}&callback={callback}",
    },
    {
        key: "searx",
        name: "Searx Belgium",
    ...
    },
    {
        ...
        suggest_url: "https://www.google.co.uk/complete/search?client=chrome&q={searchTerms}&callback={callback}",
    },
    {
        key: "bing",
        name: "Bing",
        search_url: "https://www.bing.com/search?q={searchTerms}",
        suggest_url: "https://api.bing.com/osjson.aspx?query={searchTerms}&JsonType=callback&JsonCallback={callback}",
    },
    {
        key: "baidu",
        name: "Baidu 百度",
