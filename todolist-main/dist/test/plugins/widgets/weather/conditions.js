...
exports.weatherCodes = exports.findCurrent = void 0;
/** Find conditions for the current time */
const findCurrent = (conditions, now) => {
    var _a;
    return (_a = conditions
        .slice()
        .reverse()
        .find((condition) => now >= condition.timestamp)) !== null && _a !== void 0 ? _a : null;
};
