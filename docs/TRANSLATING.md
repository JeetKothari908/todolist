...
This document gives you a step by step guide for how to add your own translations to LocalFlow!
...
9. Submit a Pull Request back to the LocalFlow repository!

You can test your changes at anytime by running a local development build of LocalFlow with `npm start`.
